...
class ClientResourceIT {
    ...
    private static final String DEFAULT_NOM = "Onhekne";
    private static final String UPDATED_NOM = "Twsvw";

    private static final String DEFAULT_PRENOM = "Hr";
    private static final String UPDATED_PRENOM = "Jro";
     ...
     *
     * @see verrimar.coopcycle.repository.search.ClientSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).mail(DEFAULT_MAIL).tel(DEFAULT_TEL).addresse(DEFAULT_ADDRESSE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).prenom(UPDATED_PRENOM).mail(UPDATED_MAIL).tel(UPDATED_TEL).addresse(UPDATED_ADDRESSE);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getAddresse()).isEqualTo(DEFAULT_ADDRESSE);
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).mail(UPDATED_MAIL).tel(UPDATED_TEL).addresse(UPDATED_ADDRESSE);
        ...
        assertThat(testClient.getAddresse()).isEqualTo(UPDATED_ADDRESSE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.mail(UPDATED_MAIL).tel(UPDATED_TEL).addresse(UPDATED_ADDRESSE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).mail(UPDATED_MAIL).tel(UPDATED_TEL).addresse(UPDATED_ADDRESSE);
