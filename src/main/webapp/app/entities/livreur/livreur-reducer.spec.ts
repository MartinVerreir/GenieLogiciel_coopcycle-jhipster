...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVREUR_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LIVREURS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LIVREUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIVREUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIVREUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIVREUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIVREUR actions', async () => {
      const expectedActions = [
        {
