...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMANDE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COMMANDES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMANDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMANDE actions', async () => {
      const expectedActions = [
        {
