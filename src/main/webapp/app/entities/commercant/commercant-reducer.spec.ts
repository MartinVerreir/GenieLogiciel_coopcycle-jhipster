...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMERCANT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COMMERCANTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COMMERCANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMERCANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMERCANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMERCANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMERCANT actions', async () => {
      const expectedActions = [
        {
