...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cooperative.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICooperative, defaultValue } from 'app/shared/model/cooperative.model';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ICooperative> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COOPERATIVE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COOPERATIVES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COOPERATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COOPERATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COOPERATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COOPERATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COOPERATIVE actions', async () => {
      const expectedActions = [
        {
