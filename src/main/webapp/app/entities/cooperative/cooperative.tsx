...
import { searchEntities, getEntities } from './cooperative.reducer';
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('coopcycleApp.cooperative.home.search')}
                />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="coopcycleApp.cooperative.nom">Nom</Translate>
                </th>
                <th>
                  <Translate contentKey="coopcycleApp.cooperative.directeur">Directeur</Translate>
                </th>
                <th />
              </tr>
            </thead>
