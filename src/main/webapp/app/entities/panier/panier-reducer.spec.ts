...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PANIER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PANIERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PANIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PANIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PANIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PANIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PANIER actions', async () => {
      const expectedActions = [
        {
