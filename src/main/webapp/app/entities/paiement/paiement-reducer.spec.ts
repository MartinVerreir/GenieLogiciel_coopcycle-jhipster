...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAIEMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAIEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAIEMENT actions', async () => {
      const expectedActions = [
        {
